...
| **macOS** | [1132-FRESH-1.0.34-macos.zip](https://github.com/domnsea/ZOOM.WTF/releases/download/v1.0.34/1132-FRESH-1.0.34-macos.zip) | `STEP 1 - OPEN FRESH ZOOM.command` |
...
| macOS | [dist/1132-FRESH-1.0.34-macos.zip](dist/1132-FRESH-1.0.34-macos.zip) |
...
LAUNCH - Window must say **1132 FRESH 1.0.34**. Use **STEP 1 - OPEN FRESH ZOOM.command**. Lime icon.
