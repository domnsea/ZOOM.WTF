...
OLD22_PLIST="$HOME/Library/LaunchAgents/wtf.fix1132.mac.22.plist"
OLD23_PLIST="$HOME/Library/LaunchAgents/wtf.fix1132.mac.23.plist"
...
OLD28_PLIST="$HOME/Library/LaunchAgents/wtf.fix1132.mac.28.plist"
OLD29_PLIST="$HOME/Library/LaunchAgents/wtf.fix1132.mac.29.plist"
OLD30_PLIST="$HOME/Library/LaunchAgents/wtf.fix1132.mac.30.plist"

printf '%s\n' "=== Uninstall $APP_NAME ==="
printf '%s\n' ""

for item in "$PLIST" "$OLD_PLIST" "$OLD12_PLIST" "$OLD13_PLIST" "$OLD14_PLIST" "$OLD15_PLIST" "$OLD16_PLIST" "$OLD17_PLIST" "$OLD18_PLIST" "$OLD19_PLIST" "$OLD20_PLIST" "$OLD21_PLIST" "$OLD22_PLIST" "$OLD23_PLIST" "$OLD24_PLIST" "$OLD25_PLIST" "$OLD26_PLIST" "$OLD27_PLIST" "$OLD28_PLIST" "$OLD29_PLIST" "$OLD30_PLIST"; do
