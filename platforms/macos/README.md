...
|---|---|---|
| **STEP 1 OPEN FRESH ZOOM** | Wipes the old Zoom identity, sets a random Join name, opens Zoom on this desktop | yes, once |
| **STEP 2 CLOSE AND CLEAN** | Restores your Mac full name and regular Zoom profile | yes, once |
