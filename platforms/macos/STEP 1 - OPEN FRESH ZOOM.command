#!/bin/bash
# STEP 1 — open Zoom as a throwaway Mac user on this desktop.
# Password once. If Zoom is still the Mac login, this fails instead
# of opening as that login (the dustin bug).
set -u
